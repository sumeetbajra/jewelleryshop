...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2 class="underline margin"><?php _e( 'Calculate shipping', 'woocommerce' ); ?></h2>
	<div class="shipping-calculator-title">
		<p><?php _e('Click','vh'); ?> <a href="#" class="shipping-calculator-button"><?php _e( 'here', 'woocommerce' ); ?></a> <?php _e('to calculate shipping fee, based on your location or shipping address.', 'vh'); ?></p>
	</div>
